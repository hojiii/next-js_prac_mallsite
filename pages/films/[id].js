...
export default function Movie({ movie, movieReviews:intialMovieReview }) {
  const [movieReviews,setMovieReviews] = useState(intialMovieReview)
  ...
  async function handleSubmit(e) {
    ...
    setMovieReviews((preMovieReviews)=>[
      nextMovieReview,
      ...preMovieReviews,
    ])
  }
